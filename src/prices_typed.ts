...
function createApp(database: Database) {
  ...
  function calculateCost(age: number | undefined, type: string, date: Date | undefined, baseCost: number, date2: any) {
    if (type === "night") {
  ...
  function calculateCostForDayTicket(age: number | undefined, date: Date | undefined, baseCost: number, date2: any) {
